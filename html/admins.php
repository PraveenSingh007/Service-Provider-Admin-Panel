...
if (($_SERVER['REQUEST_METHOD'] ?? 'GET') === 'POST' && isset($_POST['action']) && $_POST['action'] === 'delete') {
    ...
    $result = $controller->destroy($adminId, $_POST, $csrfToken, $currentUserId);
...
<html
  ...
  <head>
    ...
    <title>Admins List - Sneat Admin</title>
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="fw-bold py-3 mb-0">Admins List</h4>
                <!-- Top Right Add Admin Button -->
                <a href="add-admin.php" class="btn btn-primary">
                  <i class="icon-base bx bx-plus me-1"></i> Add Admin
                </a>
              </div>
              ...
              <!-- Admins DataTable Card -->
              <div class="card p-4">
                <div class="table-responsive">
                  <table id="adminsTable" class="table table-hover w-100">
                    <thead>
                      <tr>
                        <th>#ID</th>
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="d-flex align-items-center gap-2">
                              ...
                              <?php else: ?>
                                <span class="badge bg-label-secondary">Current Session</span>
                              <?php endif; ?>
                            </div>
                          </td>
                        </tr>
    ...
    <script>
      $(document).ready(function () {
        $('#adminsTable').DataTable({
          ...
          language: {
            search: "_INPUT_",
            searchPlaceholder: "Search admin username, role...",
