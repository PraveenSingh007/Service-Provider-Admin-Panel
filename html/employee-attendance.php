...
require_once __DIR__ . '/src/Service/AttendanceManagementService.php';

use App\Database\DatabaseConnection;
use App\Repository\AttendanceRepository;
use App\Repository\EmployeeRepository;
use App\Service\AttendanceManagementService;
...
<html
  ...
  <head>
    ...
    <title>Employee Attendance - Sneat Admin</title>
          ...
          <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
              <div class="d-flex justify-content-between align-items-center mb-4">
                <h4 class="fw-bold py-3 mb-0">Daily Attendance Tracker</h4>
