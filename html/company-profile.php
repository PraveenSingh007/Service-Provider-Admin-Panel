...
require_once __DIR__ . '/src/Service/CompanyManagementService.php';

use App\Database\DatabaseConnection;
use App\Repository\CompanyRepository;
use App\Service\CompanyManagementService;
...
<html
  ...
  <head>
    ...
    <title>Company Profile - Service Provider Admin</title>
                  ...
                  <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                      ...
                      <input
                        ...
                        id="company_name"
                        name="company_name"
                        placeholder="e.g. Sneat Services Pvt Ltd"
                  ...
                  <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                      ...
                      <input
                        ...
                        id="email"
                        name="email"
                        placeholder="e.g. contact@sneatservices.com"
            ...
            <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl d-flex flex-wrap justify-content-between py-2 flex-md-row flex-column">
                <div class="mb-2 mb-md-0">
                  © <?= date('Y') ?>, Service Provider Admin Panel
                </div>
              </div>
            </footer>
          </div>
